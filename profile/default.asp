...
<%
	...
	' Pupose: This is the default forgot password page for webaccess.
	' Basic Logic Flow:
										...
										if Request.Form("hidAction") = "1" Then
											...
											if ReturnSet("returnvalue") = 0 Then
												...
												if RndSet("returnvalue") <> 0 then
													...
													Call SendCDOMail (Request.Form("txtMail"), "spar@gatewaycomms.co.za", "Spar Forgot Password Notification", BodyText, 0)
												end if
										...
										Preloader = "document.ForgotPassword.txtUserName.focus();"
...
%>																
									...
									<tr>
										...
										<td class="tdforminput">
											<input class="text" type="text" name="txtMail" size="25" maxlength="60">
