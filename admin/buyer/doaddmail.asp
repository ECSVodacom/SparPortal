...
<%
										...
										PageTitle = "Add a New Buyer Email"
										...
										' Build the SQL
										SQL = "addBuyerMail @BuyerID=" & Request.Form("hidBuyerID") & _
											", @EMail=" & MakeSQLText(Request.Form("txtEmail"))
...
<table border="0" cellpadding="2" cellspacing="2" width="100%">
	<tr>
		<td class="pheader">Add a New Buyer Email</td>
...
<%											
											...
											' No error occured
%>
<p class="pcontent">The buyer email <b><%=Request.Form("txtEmail")%></b> was added successfully.</p>
