...
<p class="pcontent"><b>Options:</b>
	<ul>
		...
		<li class="pcontent"><a class="textnav" href="<%=const_app_ApplicationRoot%>/buyer/item.asp?id=<%=NewBuyerID%>">View the Buyer details just added</a></li>
		<li class="pcontent"><a class="textnav" href="<%=const_app_ApplicationRoot%>/buyer/buyercode.asp?id=<%=NewBuyerID%>">Edit Buyer Codes</a></li>
		<li class="pcontent"><a class="textnav" href="<%=const_app_ApplicationRoot%>/buyer/buyeremail.asp?id=<%=NewBuyerID%>">Edit Buyer Email Addresses</a></li>
	</ul>
</p>
<%		
										end if
