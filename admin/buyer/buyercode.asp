...
%>
<p class="subheader">Update Existing Codes</p>
<p class="pcontent">Below is a list of Buyer Codes for <b><%=ReturnSet("FirstName") & " " & ReturnSet("Surname")%></b>.
	<ul>
		...
		<li class="pcontent">You can also <a class="textnav" href="#Add">Add</a> a new Buyer Code on this page.</li>
	</ul>
</p>
...
%>
	<tr>
		...
		<td><input type="text" name="txtCode<%=Counter%>" id="txtCode<%=Counter%>" value="<%=ReturnSet("BuyerCode")%>" size="7" maxlength="20">
...
%>
<p class="subheader">Add a New Buyer Code<a name="Add"></p>
...
<table border="0" cellspacing="2" cellpadding="2">
	<tr>
		<td class="pcontent"><b>Buyer Code:</b></td>
		<td><input type="text" name="txtBuyerCode" id="txtBuyerCode" size="7" maxlength="20"></td>
	</tr>
	<tr>
		<td colspan="2">
