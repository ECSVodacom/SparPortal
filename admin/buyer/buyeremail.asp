...
%>
<p class="subheader">Update Existing Emails</p>
<p class="pcontent">Below is a list of Email Addresses for <b><%=ReturnSet("FirstName") & " " & ReturnSet("Surname")%></b>.
	<ul>
		...
		<li class="pcontent">You can also <a class="textnav" href="#Add">Add</a> a new Buyer Email address on this page.</li>
	</ul>
</p>
...
%>
	<tr>
		...
		<td><input type="text" name="txtMail<%=Counter%>" id="txtMail<%=Counter%>" value="<%=ReturnSet("BuyerEmail")%>" size="40" maxlength="100">
...
%>
<p class="subheader">Add a New Buyer Email<a name="Add"></p>
<p class="pcontent">Please enter a new buyer email in the text box below and click on the <b>"Add"</b> button.</p>
<form name="AddMail" id="AddMail" method="post" action="doaddmail.asp">
<table border="0" cellspacing="2" cellpadding="2">
	<tr>
		<td class="pcontent"><b>Buyer E-mail Address:</b></td>
		<td><input type="text" name="txtEmail" id="txtEmail" size="40" maxlength="100"></td>
	</tr>
	<tr>
		<td colspan="2">
