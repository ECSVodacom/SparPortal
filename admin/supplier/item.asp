...
<table border="0" cellspacing="2" cellpadding="2">
	<tr>
		...
		<td><input type="text" name="txtUserName" id="txtUserName" value="<%=txtUserName%>" size="30" maxlength="100"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Password:</b></td>
		<td><input type="password" name="txtPassword" id="txtPassword" size="20" maxlength="100"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Confirm Password:</b></td>
		<td><input type="password" name="txtConfirmPassword" id="txtConfirmPassword" size="20" maxlength="100"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Supplier Name:</b></td>
		<td><input type="text" name="txtName" id="txtName" value="<%=txtSupplierName%>" size="30" maxlength="100"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Supplier Email:</b></td>
		<td><input type="text" name="txtMail" id="txtMail" value="<%=txtSupplierMail%>" size="30"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Supplier Address:</b></td>
		<td class="pcontent"><textarea rows="5" cols="25" id="txtAddress" name="txtAddress"><%=txtAddress%></textarea></td>
	</tr>
	<tr>
...
%>
<br>
<p class="subheader">Supplier EAN Numbers</p>
...
%>	
	<tr>
		...
		<td><input type="text" name="txtSupplierCode<%=Counter%>" id="txtSupplierCode<%=Counter%>" size="20" maxlength="30"></td>
	</tr>
<%
											Next
%>	
