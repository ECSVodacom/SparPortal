...
%>
<tr>
	<td class="tbldata" align="left"><%=ReturnSet("SearchOn")%></td><td class="pcontent" align="left"><%=ReturnSet("SearchType")%></td><td class="pcontent" align="left"><%=ReturnSet("UserPassword")%></td>
</tr>
