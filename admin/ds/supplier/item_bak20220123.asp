...
<!--
							<tr>
								...
								<td>&nbsp;</td>
								<td><input type="text" name="txtPassword" id="txtPassword" value="<%=GeneratedPassword%>" size="20" maxlength="100" readonly="true" class="pcontent"></td>
							</tr>
							<tr>
								<td class="pcontent"><b>Confirm Password:</b></td>
								<td>&nbsp;</td>
								<td><input type="text" name="txtConfirmPassword" id="txtConfirmPassword" value="<%=GeneratedPassword%>" size="20" maxlength="100" readonly="true" class="pcontent"></td>
							</tr>
-->
							<tr>
								<td class="pcontent"><b>Password:</b></td>
								<td>&nbsp;</td>
								<td><input type="text" name="txtPassword" id="txtPassword"  size="20" maxlength="100" class="pcontent"></td>
							</tr>
							<tr>
								<td class="pcontent"><b>Confirm Password:</b></td>
								<td>&nbsp;</td>
								<td><input type="text" name="txtConfirmPassword" id="txtConfirmPassword"  size="20" maxlength="100"  class="pcontent"></td>
							</tr>
							<tr>
