...
<%
										...
										dim SupplierID
										Dim UserType
										'kept getting error where variable were undefined, added them below --> Xander Barnard 27/03/2015
										Dim Assign
										dIM AsCount
										Dim VendorID
										Dim MailArray
...
<%											Set ReturnSet = Nothing
											...
											SupplierID = ReturnSet("NewSupplierID")
											...
											Set ReturnSet = ExecuteSql("delLinkedSuppliers @SupplierID=" & SupplierID, curConnection)      
											' Close the Recordset
											Set ReturnSet = Nothing
											...
											For AsCount = 0 to UBound(Assign)
												...
												SQL = "editLinkedSuppliers	@ParentSupplierID=" & Request.Form("hidSupplierID") & _
											...
											For Counter = 1 to Request.Form("hidTotalCount")
												...
												if ReturnSet("returnvalue") <> 0 then
													...
													if DoDelete = 0 then
														...
														Set ReturnSet = ExecuteSql("delVendorMail @VendorID=" & VendorID, curConnection)    
...
<p class="pcontent"><b>NOTE:</b>Some errors occured during the process of adding, updating or deleting the linked suppliers and vendors.<br><br>
	Please <a class="stextnav" href="<%=const_app_ApplicationRoot%>/supplier/item.asp?id=<%=SupplierID%>"> return to the previous page and try again.</a></p>
<%													
											end if
%>
<p class="pcontent"><b>Option:</b>
	<ul>
		<li class="pcontent"><a class="stextnav" href="<%=const_app_ApplicationRoot%>/supplier/item.asp?id=<%=SupplierID%>">View Supplier just added</a></li>
	</ul>
</p>
<%											
										end if
