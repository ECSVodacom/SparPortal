...
<%											Set ReturnSet = Nothing
											...
											Set ReturnSet = curConnection.Execute ("exec delLinkedSuppliers @SupplierID=" & SupplierID)
											' Close the Recordset
											Set ReturnSet = Nothing
											...
											For Counter = 1 to Request.Form("hidTotalCount")
												...
												if Request.Form("txtVendorID" & Counter) <> "0" then
													...
													' Add a new vendor
													SQL = "exec addVendorDetail @SupplierID=" & SupplierID & _
														", @VendorCode=" & MakeSQLText(Request.Form("txtVendorCode" & Counter)) & _
