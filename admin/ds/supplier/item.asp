...
<%
										...
										'response.write SQL
											...
											if ReturnSet("returnvalue") <> 0 then
												...
												txtComments = ReturnSet("Comments")
												txtIntegrated = ReturnSet("IsIntegrated")
												
												If ReturnSet("TypeOfSupplier") = 4 Then
													txtDropshipmentSupplier = 1
												Else
													txtDropshipmentSupplier = 0
												End If
											end if
...
<!--
	...
	function validate(obj) {
		...
		if	(obj.txtName.value.indexOf("SCHEDULE") >= -1 && !obj.chkDropshipmentSupplier.checked) {
			if (window.confirm('Schedule supplier detected, mark as such?'))
			{
				obj.chkDropshipmentSupplier.checked = true;
			}
		};
					...
					<td>
						...
						%>	
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td><input type="text" name="txtPassword" id="txtPassword" value="<%=Password%>" size="20" maxlength="100" readonly="<%if ReadonOnlyPassword = "true" then response.write "true" else response.write "false"%>" class="pcontent"></td>
							</tr>
							<tr>
								<td class="pcontent"><b>Confirm Password:</b></td>
								<td>&nbsp;</td>
							<td><input type="text"   name="txtConfirmPassword" id="txtConfirmPassword" value="<%=Password%>" size="20" maxlength="100" readonly="<%if ReadonOnlyPassword = "true" then response.write "true" else response.write "false"%>" class="pcontent"></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="pcontent"><b>Comments:</b></td>
								<td>&nbsp;</td>
								<td class="pcontent"><textarea rows="5" cols="33" id="txtComments" name="txtComments" class="pcontent"><%=txtComments%></textarea></td>
							</tr>
							...
							<tr>
								<td class="pcontent"><b>Schedule Supplier?</b></td>
								<td>&nbsp;</td>
								<td><input type="checkbox" name="chkDropshipmentSupplier" id="chkDropshipmentSupplier" <%if txtDropshipmentSupplier = 1 then Response.Write "checked" end if%> class="pcontent"></td>
							</tr>
							<tr>
								<td class="pcontent"><b>Integrated Customer?</b></td>
								<td>&nbsp;</td>
								<td><input type="checkbox" name="chkIntegrate<%=Counter%>" id="chkIntegrate<%=Counter%>" <%if txtIntegrated = 1 then Response.Write "checked" end if%> class="pcontent"></td>
				...
				<tr>
					<td>
						...
						<%	
																...
																Set ReturnSet = curConnection.Execute ("exec listVendorDetail @SupplierID=" & txtSupplierID)
