...
%>
				...
				<td align="left" background="<%=const_app_ApplicationRoot%>/layout/images/hdrbg04.gif" height="25">&nbsp;&nbsp;<img src="<%=const_app_ApplicationRoot%>/layout/images/bulletcca.gif">&nbsp;<font color="#ffffff">For Support contact:&nbsp;</font><font color="  #ffffff  "><b>082 1951</b></font></td>
