...
<%
	...
	Function PageNav (URL, ClassName, RecCount, BandSize, RecFrom, RecTo, NumPages, RecBand)
...
<%
		...
		if RecBand > 1 Then
%>
<a class="stextnav" href="<%=URL%>?page=<%=RecBand - 1%>">Previous&nbsp;Page&nbsp;|</a>
<%		
		end if
...
%>
<a class="stextnav" href="<%=URL%>?page=<%=RecBand + 1%>">Next&nbsp;Page&nbsp;|</a>
<%			
		end if
...
%>
<a class="stextnav" href="<%=URL%>?page=<%=Counter%>">Page&nbsp;<%=Counter%></a>&nbsp;|
<%										
			end if
		next	
%>
