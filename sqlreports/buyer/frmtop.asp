...
<html>
	<head>
		<title>SPAR DC TRACK & TRACE</title>
		...
		<tr>
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tbody>
						<tr>
							<td rowspan="2" align="center" background="<%=const_app_ApplicationRoot%>/layout/images/hdrbg01.gif" height="93" valign="top" width="242">
								<a href="http://www.gatewaycomms.com" target="_NEW">
						...
						<tr>
							<td align="right" background="<%=const_app_ApplicationRoot%>/layout/images/hdrbg03.gif" height="82">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tbody>
										<tr>
											<td width="80%" align="center"><H1>SPAR DISTRIBUTION CENTRE:<br>TRACKING FACILITY</H1></td>
...
<%				End If	%>
				...
				<td align="right" background="<%=const_app_ApplicationRoot%>/layout/images/hdrbg04.gif" height="25">&nbsp;&nbsp;<img src="<%=const_app_ApplicationRoot%>/layout/images/bulletcca.gif">&nbsp;<font color="#ffffff"><a target="_blank" class="search" href="<%=const_app_ApplicationRoot%>/tracktrace/buyer/default.asp?action=6">Remittance Advices</a></font></td>
