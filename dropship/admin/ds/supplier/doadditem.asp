...
<%											
											...
											Set ReturnSet = ExecuteSql("exec delLinkedSuppliers @SupplierID=" & SupplierID, curConnection)   
											' Close the Recordset
											Set ReturnSet = Nothing
											...
											For Counter = 1 to Request.Form("hidTotalCount")
												...
												if ReturnSet("returnvalue") <> 0 then
													...
													if DoDelete = 0 then
														...
														Set ReturnSet = ExecuteSql("exec delVendorMail @VendorID=" & VendorID, curConnection) 
