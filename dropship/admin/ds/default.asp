...
<%
	...
	' Pupose: This is the default login page for SPAR DS Admin System.
	' Basic Logic Flow:
										...
										if Request.Form("hidAction") = "1" Then
											...
											if ReturnSet("returnvalue") <> 0 Then
												...
												Call SetUserDetails (ReturnSet("UserID"), Request.Form("DCEAN"), Request.Form("DCMail"), ReturnSet("Permission"), ReturnSet("DCID"), ReturnSet("DCName"))
												'	  SetUserDetails (UserID, UserName, EMail,Permission, DCID, DCName)	
...
<p class="pheader">SPAR Drop Shipment - Administration Management System</p>
<hr>
