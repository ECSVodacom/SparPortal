<!--
	function addRows(id,count){
		...
		td2.appendChild(document.createElement("<input type='hidden' name='txtVendorID" + tdcount + "' id=txtVendorID" + tdcount + "' value='0'>"))
		...
		var td4 = document.createElement("<td class='tbldata'></td>")
		...
		var td5 = document.createElement("<td class='tbldata'></td>")
