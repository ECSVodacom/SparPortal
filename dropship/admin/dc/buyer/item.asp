...
%>	
	<tr>
		...
		<td class="pcontent"><input type="password" name="txtPassword" id="txtPassword" value="" size="20" maxlength="100" class="pcontent"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Confirm Password:</b></td>
		<td class="pcontent"><input type="password" name="txtConfirmPassword" id="txtConfirmPassword" value="" size="20" maxlength="100" class="pcontent"></td>
	</tr>
	<tr>
