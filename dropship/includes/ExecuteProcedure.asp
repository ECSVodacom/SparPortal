...
'cmdObj.CommandTimeout = 600
		...
		Else
			...
			For idx = 0 To ResultCount - 1
				...
				If ParamName = "@AmtExcl" Or ParamName="@Vat" Or ParamName = "@AmtIncl" Or ParamName = "@Total" Then ParamValue = Replace(ParamValue,".",",")
		...
		'Set ExecuteSql = ActiveConnection.Execute(QueryString)
