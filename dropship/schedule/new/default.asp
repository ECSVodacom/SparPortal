...
<%
										...
										Set ReturnSet = curConnection.Execute ("exec listDC @DC=" & Session("DCID"))
		...
		<tr>
			...
			<td>
				<select name="drpSupplier" id="drpSupplier" class="pcontent" onchange="setSupplierSelectedVal();">
					...
					Set ReturnSet = curConnection.Execute ("exec listScheduleSupplier @SupplierID=" & SupplierId & ", @DCId=" & dcId & ", @HiddenIsForceCredit=" & IsForceCreditNumeric & ", @IsRewardsNumeric=" & IsRewardsNumeric)
	'rESPONSE.wRITE "exec listScheduleSupplier @SupplierID=" & SupplierId & ", @DCId=" & dcId & ", @HiddenIsForceCredit=" & IsForceCreditNumeric & ", @IsRewardsNumeric=" & IsRewardsNumeric
