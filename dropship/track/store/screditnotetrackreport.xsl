	...
	<xsl:template match="cnote">
		<tr>
			<td class="pcontent" align="center">
				<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/creditnote/default.asp?item={@id}', 'CreditNoteDetail', 'width=1200,height=800,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
      ...
      <td class="pcontent" align="center">
        ...
        <br/>[<xsl:value-of select="receivedtime"/>]
      </td>
      <td class="pcontent" align="center">
        <xsl:value-of select="transdate"/>
        <br/>[<xsl:value-of select="transtime"/>]
      </td>
      <xsl:choose>
        <xsl:when test="postdate!=''">
          <td class="pcontent" align="center">
            <xsl:value-of select="postdate"/>
            <br/>[<xsl:value-of select="posttime"/>]
          </td>
        </xsl:when>
        <xsl:otherwise>
          <td class="pcontent" align="center">-</td>
			...
			<xsl:choose>
				<xsl:when test="invid!='0'">
					<td class="pcontent" align="center">
						<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/invoice/default.asp?item={invid}', 'InvoiceDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
			...
			<xsl:choose>
				<xsl:when test="totclaim!='0'">
					<td class="pcontent" align="center">
						<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/creditnote/default.asp?item={@id}', 'CreditNoteDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">List Referenced Claims</a>
					</td>
				</xsl:when>
				<xsl:otherwise>
					<td class="pcontent" align="center">-</td>
