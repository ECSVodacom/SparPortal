		...
		<table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolor="#4C8ED7">
			...
			<tr>
				...
				<td class="pcontent" valign="top">&#160;&#160;&#160;<b>R</b>&#160;
						<xsl:choose>
							<xsl:when test="//rootnode/smmessage/numlines='0'">
								<!--<xsl:choose>
									<xsl:when test="//rootnode/smmessage/subamt!=''"><xsl:value-of select="format-number (//rootnode/smmessage/subamt,'DDD,DD0.00', 'staff')"/></xsl:when>
									<xsl:otherwise>
										0.00						
									</xsl:otherwise>
								</xsl:choose>-->
								<xsl:value-of select="format-number (//rootnode/smmessage/amt,'DDD,DD0.00', 'staff')"/>
								<br/>
								<xsl:choose>
								...
								<br/>
									&#160;&#160;&#160;<b>R</b>&#160;&#160;<xsl:value-of select="format-number (//rootnode/smmessage/amt + //rootnode/smmessage/vat,'DDD,DD0.00', 'staff')"/>
									<!--
									<xsl:choose>
									<
							...
							<xsl:otherwise>							
									...
									<xsl:choose>
											...
											<xsl:when test="//rootnode/smmessage/discperc1!='' and //rootnode/smmessage/discperc2=''">			
												<xsl:value-of select="format-number (sum(//rootnode/smmessage/claimline/subtot) - (sum(//rootnode/smmessage/claimline/subtot) * (//rootnode/smmessage/discperc1) div 100) + //rootnode/smmessage/vat,'DDD,DDD.00', 'staff')"/>
											</xsl:when>
											<xsl:when test="//rootnode/smmessage/discperc1='' and //rootnode/smmessage/discperc2!=''">			
												<xsl:value-of select="format-number (sum(//rootnode/smmessage/claimline/subtot) - ((sum(//rootnode/smmessage/claimline/subtot) - (sum(//rootnode/smmessage/claimline/subtot) * (//rootnode/smmessage/discperc1) div 100)) *//rootnode/smmessage/discperc2  div 100) + //rootnode/smmessage/vat,'DDD,DDD.00', 'staff')"/>
											</xsl:when>
											<xsl:when test="//rootnode/smmessage/discperc1='' and //rootnode/smmessage/discperc2=''">			
												<xsl:value-of select="format-number (sum(//rootnode/smmessage/claimline/subtot) + //rootnode/smmessage/vat,'DDD,DDD.00', 'staff')"/>
											</xsl:when>		
											<xsl:otherwise>
												<xsl:value-of select="format-number (sum(//rootnode/smmessage/claimline/subtot),'DDD,DDD.00', 'staff')"/>						
											</xsl:otherwise>
