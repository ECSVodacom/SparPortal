	...
	<form action="default.asp?item={//rootnode/smmessage/invoiceid}" method="post" name="updateorder" id="updateorder" onsubmit="return validate(this);">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td class="pcontent" align="center">
					...
					<!--
					<input type="button" name="btnDownXML" id="btnDownXML" value="Download XML File" class="button" onClick="javascript:location.href='@@ApplicationRoot/track/supplier/filedownload/default.asp?id=@@InvID&amp;type=xml&amp;action=inv'"/>&#160;
					<input type="button" name="btnDownTxt" id="btnDownTxt" value="Download Text File" class="button" onClick="javascript:location.href='@@ApplicationRoot/track/supplier/filedownload/default.asp?id=@@InvID&amp;type=txt&amp;action=inv'"/>&#160;
					-->
		...
		<table border="1" cellpadding="0" cellspacing="0" width="100%">
			<tr bgcolor="#4C8ED7">
				...
				<td class="tdcontent" align="center"><b>Total Order<br/>(excl VAT)</b></td> <!-- -->
 ...
 <xsl:template match="invline" >
 	<tr>
		...
		<xsl:choose>
 		...
 		<td class="pcontent" align="right">
 			<xsl:choose>
 				<xsl:when test="totalorderexcl='0' or totalorderexcl='0.00'">
 					0.00&#160;&#160;
 				</xsl:when>
 				<xsl:otherwise>
 					<xsl:value-of select="format-number (totalorderexcl,'DDD,DDD.00', 'staff')"/>&#160;&#160;
 				</xsl:otherwise>
 			</xsl:choose>
 		</td>
 		<td class="pcontent" align="right">
