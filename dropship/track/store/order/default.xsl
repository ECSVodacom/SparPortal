				...
				<td class="pcontent" align="center">
						...
						<xsl:when test="//rootnode/smmessage/greyoutlistinvoices='0'"> <!--   -->
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/invoicecount=1">
									<input type="button"  name="btnListInvoices"  id="btnListInvoices" value="List Invoices" onclick="javascript: window.open('@@ApplicationRoot/track/store/invoice/default.asp?item={//rootnode/smmessage/invoiceid}','blank');" class="button"/>&#160;
								</xsl:when>
								<xsl:when test="//rootnode/smmessage/invoicecount>1">
									<input type="button"  name="btnListInvoices" id="btnListInvoices" value="List Invoices" onclick="javascript: window.open('@@ApplicationRoot/track/store/invoice/list.asp?item=@@OrdID','blank');" class="button"/>&#160;
								</xsl:when>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/greyoutorderconfirmation='0'"> 
							<input type="button" name="btnOrderConfirmations" id="btnOrderConfirmations" value="Order Confirmations" onclick="javascript: location.href='@@ApplicationRoot/track/store/order/confirmation/default.asp?item={//rootnode/smmessage/invoiceid}'" class="button"/>&#160;
						</xsl:when>
						<xsl:otherwise>
