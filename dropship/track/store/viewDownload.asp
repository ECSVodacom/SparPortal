...
<form name="FrmTmp" id="FrmTmp" method="post" action="<%=const_app_ApplicationRoot%>/track/dc/doDownload.asp">
    ...
    <table class="pcontent" border="0">
        ...
        <tr>
            ...
            <td style="width: 102px; height: 21px">
                <select onchange="javascript:onDropdownChange()" class="pcontent" name="ReportType" style="width: 200px; height: 22px">
