	...
	<form action="doorder.asp?id=@@XMLFile" method="post" name="updatecr" id="updatecr" onsubmit="return validate(this);">
		<table border="0" cellpadding="2" cellspacing="2" width="100%">
			<tr>
				...
				<td class="iheader" align="left">CREDIT NOTE - REFERENCED CLAIM&#160;
				<xsl:choose>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <input type="button" name="btnPrintCopy" id="btnPrintCopy" value="Print Copy Tax Credit Note" class="button"  onclick="javascript: validatePrint(document.updatecr);"/>&#160;
