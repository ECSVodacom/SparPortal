...
<xsl:choose>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td class="pcontent" align="center">
					<input type="button" name="btnDownXML" id="btnDownXML" value="Download XML File" class="button" onClick="javascript:location.href='@@ApplicationRoot/track/store/filedownload/default.asp?id={rootnode/smmessage/cnid}&amp;type=xml&amp;action=cn'"/>&#160;
					<input type="button" name="btnDownTxt" id="btnDownTxt" value="Download Text File" class="button" onClick="javascript:location.href='@@ApplicationRoot/track/store/filedownload/default.asp?id={rootnode/smmessage/cnid}&amp;type=txt&amp;action=cn'"/>&#160;
 ...
 <xsl:template match="claim">
		<!--<xsl:if test="position()>=2">-->
				<tr>
					<td class="pcontent" align="center"><a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/creditnote/item.asp?item={creditnoteclaimid}', 'CreditNoteClaimLines', 'width=1200,height=900,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">View</a></td>
					<td class="pcontent" align="center"><a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/creditnote/item.asp?item={creditnoteclaimid}', 'CreditNoteClaimLines', 'width=1200,height=900,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');"><xsl:value-of select="claimnum"/></a></td>
