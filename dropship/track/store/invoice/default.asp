...
<!--
	function validatePrint(obj) {
		if ((obj.hidSupplierVatNo.value=='') || (obj.hidStoreVatNo=='')) {
			...
			window.open('<%=const_app_ApplicationRoot%>/track/store/invoice/default.asp?item=<%=InvoiceID%>&amp;type=copy','PrintCopyDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');
		}
	}
//-->
</script>
