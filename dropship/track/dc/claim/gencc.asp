...
<%						
										...
										if Request.Form("hidAction") = "1" then
											...
											SQL = "addCreditNote @StoreEAN=" & MakeSQLText(Request.Form("hidStoreEAN")) & _
											...
											if ReturnSet("returnvalue") <> 0 then
												...
												SQL = "editCreditNoteExtra @CreditNoteID=" & CCID & _
												...
												If ReturnSet("returnvalue") <> 0 then
													...
													SQL = "addCreditNoteClaim @CNID=" & CCID & _
													...
													if ReturnSet("returnvalue") <> 0 then
														...
														SQL = "editCreditNoteClaimExtra @CreditNoteClaimID=" & CCClaimID & _
															", @TotCostExcl=" & Replace(Request.Form("txtAmtExcl"),",","") & _
															", @TotVat=" & Replace(Request.Form("txtTotVat"),",","") & _
														...
														if ReturnSet("returnvalue") <> 0 then
															...
															SQL = "itemCreditNoteClaim @CCID=" & CCID
															...
															Response.Redirect const_app_ApplicationRoot & "/track/dc/creditnote/default.asp?item=" & CCID
															Response.Flush
														end if
													end if
												end if  
