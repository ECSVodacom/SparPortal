...
<%
										...
										if IsNumeric(Trim(XMLDoc.selectSingleNode("//rootnode/smmessage/trade2perc").text)) Then
										...
										For LineCount = 0 to LineItems.Length-1
											...
											'If IsNumeric(LineItems.item(LineCount).selectSingleNode("subtotexcl").text) Then _
											'	SubTotExcl = SubTotExcl + CDbl(LineItems.item(LineCount).selectSingleNode("subtotexcl").text)
										Next
