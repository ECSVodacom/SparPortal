...
<%
										...
										XSLDoc.async = false
										'XSLDoc.Load(const_app_ApplicationRoot & "/track/dc/invoice/new.xsl")
										...
										' execute the SQL
										Set ReturnSet = ExecuteSql("exec listStores", curConnection)  
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="10" topmargin="10" marginwidth="10" marginheight="10" background="" onload="calcTots();loadDefault();GetVals ('-1');">
<%
										' Write the XMLString 
