...
<xsl:decimal-format name="staff" decimal-separator="." grouping-separator=","/>
	...
	<form action="doorder.asp?id=@@XMLFile" method="post" name="updateorder" id="updateorder" onsubmit="return validate(this);">
					...
					<table border="0" cellpadding="2" cellspacing="0" width="100%" bordercolor="#4C8ED7">
						<tr>
							...
							<td class="pcontent"><br/><br/>
									...
									<xsl:if test="//rootnode/smmessage/authno!=''">
											<br/><b>ORDER AUTHORIZATION #: </b>&#160;<xsl:value-of select="//rootnode/smmessage/authno"/><br/>
									</xsl:if>	
							</td>
						</tr>
					</table>
		...
		<table border="1" cellpadding="0" cellspacing="0" width="100%">
			<tr bgcolor="#4C8ED7">
				...
				<td class="tdcontent" align="center"><b>Ord<br/>Qty</b></td>
				...
				<td class="tdcontent" align="center"><b>Order<br/>Line<br/>Cost</b></td>
			...
			<tr bgcolor="#4C8ED7">
				...
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (//rootnode/smmessage/subtotvat,'###,##0.00', 'staff')"/></b>&#160;&#160;</td>
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (sum(//rootnode/smmessage/invline/total),'###,##0.00', 'staff')"/></b>&#160;&#160;</td>
				<td>&#160;</td>
			</tr>
					...
					<xsl:choose>
							<xsl:when test="//rootnode/smmessage/trade1perc!=''">
								<xsl:choose>
									...
									<xsl:otherwise>
										<xsl:value-of select="format-number (//rootnode/smmessage/trade1perc,'###,##0.00', 'staff')"/>&#160;%
									</xsl:otherwise>
								</xsl:choose>
							</xsl:when>
							<xsl:otherwise>
								<xsl:choose>
									<xsl:when test="//rootnode/smmessage/trade1rand!=''">
										<xsl:value-of select="format-number (//rootnode/smmessage/trade1rand,'###,##0.00', 'staff')"/>&#160;R
									</xsl:when>
									<xsl:otherwise>
										0.00 %
									</xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/trade2perc!=''">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="format-number (//rootnode/smmessage/trade2perc,'###,##0.00', 'staff')"/>&#160;%
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/trade2rand!=''">
									<xsl:value-of select="format-number (//rootnode/smmessage/trade2rand,'###,##0.00', 'staff')"/>&#160;R
								</xsl:when>
								<xsl:otherwise>
									0.00 %
								</xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/additionalperc!=''">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="format-number (//rootnode/smmessage/additionalperc,'###,##0.00', 'staff')"/>&#160;%
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/trade2rand!=''">
									<xsl:value-of select="format-number (//rootnode/smmessage/additionalrand,'###,##0.00', 'staff')"/>&#160;R
								</xsl:when>
								<xsl:otherwise>
									0.00 %
								</xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/transperc!=''">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="format-number (//rootnode/smmessage/transperc,'###,##0.00', 'staff')"/>&#160;%
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/transrand!=''">
									<xsl:value-of select="format-number (//rootnode/smmessage/transrand,'###,##0.00', 'staff')"/>&#160;R
								</xsl:when>
								<xsl:otherwise>
									0.00 %
								</xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/dutlevperc!=''">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="format-number (//rootnode/smmessage/dutlevperc,'###,##0.00', 'staff')"/>&#160;%
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/dutlevrand!=''">
									<xsl:value-of select="format-number (//rootnode/smmessage/dutlevrand,'###,##0.00', 'staff')"/>&#160;R
								</xsl:when>
								<xsl:otherwise>
									0.00 %
								</xsl:otherwise>
			...
			<tr bgcolor="#4C8ED7">
				...
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (//rootnode/smmessage/grandtotexcl,'###,##0.00', 'staff')"/></b>&#160;&#160;</td>
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (//rootnode/smmessage/grandtotvat,'###,##0.00', 'staff')"/></b>&#160;&#160;</td>
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (//rootnode/smmessage/grandtotincl,'###,##0.00', 'staff')"/></b>&#160;&#160;</td>
				<td>&#160;</td>
			</tr>
			<!-- End Invoice Totals -->
					...
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/setdiscperc!=''">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="format-number (//rootnode/smmessage/setdiscperc,'###,##0.00', 'staff')"/>&#160;%
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
 	...
 	<tr>
		...
		<xsl:choose>
			<xsl:when test="orderlinecost!=''">
				<td class="pcontent" bgcolor="#FFFF00" align="center"><b><xsl:value-of select="format-number (orderlinecost,'###,##0.00', 'staff')"/>&#160;&#160;</b></td>
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
			</xsl:otherwise>
		...
		<xsl:choose>
 		...
 		<td class="pcontent" align="right">
			<xsl:choose>
				<xsl:when test="deal1perc!='0' and deal1rand='0'">
					<xsl:value-of select="format-number (deal1perc,'###,##0.00', 'staff')"/>&#160;%&#160;&#160;						
				</xsl:when>
				<xsl:when test="deal1perc='0' and deal1rand!='0'">
					<xsl:value-of select="format-number (deal1rand,'###,##0.00', 'staff')"/>&#160;&#160;
				</xsl:when>
				<xsl:when test="deal1perc='0' and deal1rand='0'">
					<xsl:value-of select="format-number (deal1rand,'###,##0.00', 'staff')"/>&#160;&#160;
				</xsl:when>
				<xsl:when test="deal1perc!='0' and deal1rand!='0'">
					<xsl:value-of select="format-number (deal1perc,'###,##0.00', 'staff')"/>&#160;/<br/><xsl:value-of select="format-number (deal1rand,'###,##0.00', 'staff')"/>
				</xsl:when>
			</xsl:choose>
 		</td>
 		<td class="pcontent" align="right">
			<xsl:choose>
				<xsl:when test="deal2perc!='0' and deal2rand='0'">
					<xsl:value-of select="format-number (deal2perc,'###,##0.00', 'staff')"/>&#160;%&#160;&#160;						
				</xsl:when>
				<xsl:when test="deal2perc='0' and deal2rand!='0'">
					<xsl:value-of select="format-number (deal2rand,'###,##0.00', 'staff')"/>&#160;&#160;
				</xsl:when>
				<xsl:when test="deal2perc='0' and deal2rand='0'">
					<xsl:value-of select="format-number (deal2rand,'###,##0.00', 'staff')"/>&#160;&#160;
				</xsl:when>
				<xsl:when test="deal2perc!='0' and deal2rand!='0'">
					<xsl:value-of select="format-number (deal2perc,'###,##0.00', 'staff')"/>&#160;/<br/><xsl:value-of select="format-number (deal2rand,'###,##0.00', 'staff')"/>
				</xsl:when>
			</xsl:choose>
			<!--<xsl:choose>
				...
				<xsl:otherwise>
					<xsl:choose>
						<xsl:when test="deal2rand!='0' or deal2rand='0.00'">
							<b>R</b>&#160;<xsl:value-of select="format-number (deal2rand,'###,##0.00', 'staff')"/>
						</xsl:when>
						<xsl:otherwise>
							0.00&#160;&#160;
						</xsl:otherwise>
 		...
 		<td class="pcontent" align="right">
 			<xsl:choose>
 				...
 				<xsl:otherwise>
 					<xsl:value-of select="format-number (nettcost,'###,##0.00', 'staff')"/>&#160;&#160;
 				</xsl:otherwise>
 			</xsl:choose>
 		</td>
 		<td class="pcontent" align="right">
 			<xsl:choose>
 				...
 				<xsl:otherwise>
 					<xsl:value-of select="format-number (vat,'###,##0.00', 'staff')"/>&#160;&#160;
 				</xsl:otherwise>
 			</xsl:choose>
 		</td>
 		<td class="pcontent" align="right">
 			<xsl:choose>
 				...
 				<xsl:otherwise>
 					<xsl:value-of select="format-number (vatr,'###,##0.00', 'staff')"/>&#160;&#160;
 				</xsl:otherwise>
 			</xsl:choose>
 		</td>
		...
		<xsl:choose>
			<xsl:when test="totalorder!=''">
				<td class="pcontent" bgcolor="#FFFF00" align="center"><b><xsl:value-of select="format-number (totalorder,'###,##0.00', 'staff')"/>&#160;&#160;</b></td>
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
			</xsl:otherwise>
			...
			<xsl:when test="totalorder!=''">
				<xsl:choose>
					<xsl:when test="totalorder = total">
						<td class="pcontent" bgcolor="#FFFF00" align="center"><b><xsl:value-of select="format-number (total,'###,##0.00', 'staff')"/>&#160;&#160;</b></td>
					</xsl:when>
					<xsl:otherwise>
						<td class="pcontent" bgcolor="red" align="center"><b><xsl:value-of select="format-number (total,'###,##0.00', 'staff')"/>&#160;&#160;</b></td>
					</xsl:otherwise>
				 </xsl:choose>
			</xsl:when>
			<xsl:otherwise>
