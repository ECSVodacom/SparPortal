...
<xsl:choose>
	...
	<xsl:otherwise>
	<form action="donewinv.asp?item=@@OrdID" method="post" name="frmInvoice" id="frmInvoice" onsubmit="return validate(this);">
	<table border="0" cellpadding="2" cellspacing="2" width="100%">
					...
					<table border="0" cellpadding="2" cellspacing="0" width="100%" bordercolor="#4C8ED7">
						...
						<tr>
							<td class="pcontent">
								...
								<input type="text" name="txtDelivDate" id="txtDelivDate" value="" class="pcontent"/>&#160;[dd/mm/ccyy]
							</td>
						</tr>
					</table>
				</td>
		...
		<table border="2" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
		 		<td class="pcontent" align="center">1</td>
				...
				<td class="pcontent" align="center" valign="top">
					...
					<input type="text" name="txtDealpercOne1" id="txtDealpercOne1" size="3" value="0.00" class="tdcontentblack" onblur="calcTotalExcl(1);"/>
				...
				<td class="pcontent" align="center" valign="top">
					...
					<input type="text" name="txtDealpercTwo1" id="txtDealpercTwo1" size="3" value="0.00" class="tdcontentblack" onblur="calcTotalExcl(1);"/>
					<input type="hidden" name="hidDealpercTwo1" id="hidDealpercTwo1" value="0.00" />
				</td>						
				<td class="pcontent" align="center">
					<input type="text" name="txtTotalExcl1" id="txtTotalExcl1" value="0.00" size="3" class="tblcontent" onchange="calcTotalExcl(1);" disabled="true"/>
				...
				<td class="pcontent" align="center"><input type="text" name="txtVatr1" id="txtVatr1" value="0.00" size="3" class="tblcontent" onchange="calcTotalExcl(1);" disabled="true"/>
					<input type="hidden" name="hidVatr1" id="hidVatr1" value="0.00"/>
				</td>
				<td class="pcontent" align="center"><input type="text" name="txtTotalIncl1" id="txtTotalIncl1" value="0.00" size="3" class="tblcontent" onchange="calcTotalExcl(1);" disabled="true"/>					
			...
			<tr>	
				<td>&#160;</td>
				<td class="pcontent" colspan="14" align="left" valign="middel"><input type="button" name="btnAddNew" id="btnAddNew" value="Add New Line" class="button" onclick="addRows('frmInvoice',document.frmInvoice.hidTotalCount.value)"/></td>
			</tr>	
			...
			<tr bgcolor="#4C8ED7">
				...
				<td class="tdcontent" align="right"><b>R&#160;</b><input type="text" name="txtNettTotIncl" id="txtNettTotIncl" size="3" value="0.00" class="tblcontent" disabled="true"/><input type="hidden" name="hidNettTotIncl" id="hidNettTotIncl" value="0.00"/>&#160;&#160;
					...
					<input type="hidden" name="hidSupVat" id="hidSupVat" value="@@SupVat"/>
