			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Claim Number</i></b><br/>
					</th>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Claim Type</i></b><br/>
					</th>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Claim Category</i></b><br/>
					</th>					
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>File</i></b><br/>
						<b><i>Received</i></b><br/>
					...
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Manual<br/>Claim Number</i></b>
					</th>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Manual<br/>Claim Date</i></b>
					</th>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Invoice<br/>Number</i></b>
					</th>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
						<b><i>Invoice<br/>Date</i></b>
					</th>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
...
<xsl:template match="claim">	
	<tr>
		<td class="pcontent" align="center">
			...
			<xsl:value-of select="claimnumber"/></a></td>
		...
		<td class="pcontent" align="center"><xsl:value-of select="receiveddate"/><br/>[<xsl:value-of select="receivedtime"/>]</td>
		<td class="pcontent" align="center"><xsl:value-of select="transdate"/><br/>[<xsl:value-of select="transtime"/>]</td>	
		<td class="pcontent" align="center"><xsl:value-of select="transdate"/><br/>[<xsl:value-of select="transtime"/>]</td>			
		<xsl:choose>
		...
		<xsl:choose>
			<xsl:when test="manualnum!=''">	
				<td class="pcontent" align="center"><xsl:value-of select="manualnum"/></td>				
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
			</xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="manualdate!=''">	
				<td class="pcontent" align="center"><xsl:value-of select="manualdate"/></td>				
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
			</xsl:otherwise>
		...
		<td class="pcontent" align="center">
			<xsl:choose>
				<xsl:when test="invnum!=''">
					<xsl:choose>
						<xsl:when test="invid!=''">
							<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/dc/invoice/default.asp?item={invid}', 'InvoiceDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');"><xsl:value-of select="invnum"/></a>
						</xsl:when>
						<xsl:otherwise>
		...
		<td class="pcontent" align="center">
			<xsl:choose>
				<xsl:when test="cnnum!=''">
					<xsl:choose>
						<xsl:when test="cnid!=''">
							<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/dc/creditnote/default.asp?item={cnid}', 'CNDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');"><xsl:value-of select="cnnum"/></a>
						</xsl:when>
						<xsl:otherwise>
		...
		<!--<xsl:choose>
			<xsl:when test="cncount!='0'">					
				<td class="pcontent" align="center">
					<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/dc/creditnote/item.asp?item={@id}', 'ListCreditNotes', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
					list</a>
				</td>
			</xsl:when>
			<xsl:otherwise>
