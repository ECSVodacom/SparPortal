...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="store">
    <tr>
      <td class="mheader" colspan="12" bgcolor="#ccccc2">
        SPAR Store: <xsl:value-of select="name"/>
      </td>
    </tr>
  ...
  <xsl:template match="supplier">
    <tr>
      <td class="nheader" colspan="10" bgcolor="#333366">
        Supplier: <xsl:value-of select="name"/> (<xsl:value-of select="eannumber"/>)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td class="pcontent" align="center">
        <xsl:choose>
          <xsl:when test="cnnum!=''">
            <xsl:choose>
              <xsl:when test="cnid!=''">
                <a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/supplier/creditnote/default.asp?item={cnid}', 'CNDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
