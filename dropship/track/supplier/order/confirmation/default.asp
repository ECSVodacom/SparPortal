...
<%
										...
										If XMLDoc.selectSingleNode("//rootnode/smmessage/trade2rand").text = "0" Then
											Trade2TotExcl = CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/subtotexcl").text) * CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/trade2perc").text / 100)
											Trade2TotVat = VatR * CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/trade2perc").text) / 100
										...
										If XMLDoc.selectSingleNode("//rootnode/smmessage/additionalrand").text = "0" Then
											AddTotExcl = CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/subtotexcl").text) * CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/additionalperc").text / 100)
											AddTotVat = VatR * CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/additionalperc").text) / 100
