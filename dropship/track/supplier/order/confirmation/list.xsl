...
<xsl:choose>
	...
	<xsl:otherwise>
	<form action="default.asp?item={//rootnode/smmessage/invoiceid}" method="post" name="updateorder" id="updateorder" onsubmit="return validate(this);">
		<table border="0" cellpadding="2" cellspacing="2" width="100%">
			<tr>
				<td><img src="@@ApplicationRoot/layout/images/sparlogo.gif"/></td>
				<td class="iheader" align="center">Order Confirmation</td>
			</tr>
		</table><br/>
							...
							<td class="pcontent"><br/><br/>
									...
									<xsl:choose>
										<xsl:when test="//rootnode/smmessage/ordernumber!=''">
											&#160;<a href="../default.asp?item={//rootnode/smmessage/orderid}" target="_blank"><xsl:value-of select="//rootnode/smmessage/ordernumber"/></a><br/>
										</xsl:when>
										<xsl:otherwise>
											&#160;<b>Not Supplied</b><br/>
										</xsl:otherwise>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td class="pcontent" align="center">
					<select id="txtFilter" name="txtFilter" onchange="form.submit();" class="pcontent">
					...
					<input type="submit" name="btnSave" id="btnSave" value="Save" class="button"  onclick=""/>&#160;
		...
		<table border="1" cellpadding="0" cellspacing="0" width="100%">
			<tr bgcolor="#4C8ED7">
				...
				<td class="tdcontent" align="center"><b>Invoice List<br/>Cost</b></td> 
				<td class="tdcontent" align="center"><b>Deal1<br/>%/R</b></td>
				<td class="tdcontent" align="center"><b>Deal2<br/>%/R</b></td>
				<td class="tdcontent" align="center"><b>Total Invoice<br/>(excl VAT)</b></td> <!-- -->
				<td class="tdcontent" align="center"><b>VAT %</b></td>
				<td class="tdcontent" align="center"><b>VAT R</b></td>
				<td class="tdcontent" align="center"><b>Order<br />Total<br/>(incl VAT)</b></td>
				<td class="tdcontent" align="center"><b>Invoice<br />Total<br/>(incl VAT)</b></td>
		...
		<xsl:choose>
		<xsl:when test="//rootnode/smmessage/hidetotals=0">
			<tr bgcolor="#4C8ED7">
				<td class="tdcontent" colspan="9"><b>Total:</b></td>
				<td>&#160;</td>
				<!--<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (//rootnode/smmessage/subtotexcl,'DDD,DDD.00', 'staff')"/></b>&#160;&#160;</td>-->
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (sum(//rootnode/smmessage/invline/nettcost),'DDD,DDD.00', 'staff')"/></b>&#160;&#160;</td>
				...
				<td class="tdcontent" align="right"><b>R&#160;<xsl:value-of select="format-number (sum(//rootnode/smmessage/invline/vatr),'DDD,DDD.00', 'staff')"/></b>&#160;&#160;</td>
				<td>&#160;</td>
			...
			<tr>
				<td class="pcontent" colspan="9">Trade 1: &#160;
					<xsl:choose>
							<xsl:when test="//rootnode/smmessage/trade1rand='0'">
								<xsl:choose>
			...
			<tr>
				<td class="pcontent" colspan="9">Trade 2: 	&#160;
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/trade2rand='0'">
							<xsl:choose>
			...
			<tr>
				<td class="pcontent" colspan="9">Additional Discount: &#160;
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/additionalrand='0'">
							<xsl:choose>
			...
			<tr>
				<td class="pcontent" colspan="9">Transport : 
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/transrand='0'">
							<xsl:choose>
			...
			<tr bgcolor="#4C8ED7">
				...
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;@@InvoiceTotalExcl</b>&#160;&#160;</td>
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;@@InvoiceTotalVat</b>&#160;&#160;</td>
				<td>&#160;</td>
				<td class="tdcontent" align="right"><b>R&#160;@@InvoiceTotalIncl</b>&#160;&#160;</td>
				<td>&#160;</td>						
			<!--					
			...
			<tr>
				<td class="pcontent" colspan="9">Settlement Discount:
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/setdiscrand='0'">
							<xsl:choose>
						...
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/setdiscrand!=''">
									<xsl:value-of select="format-number (//rootnode/smmessage/setdiscrand,'DDD,DDD.00', 'staff')"/>&#160;R
								</xsl:when>
								<xsl:otherwise>
									0.00 %
								</xsl:otherwise>
 	...
 	<tr>
		...
		<xsl:choose>
			<xsl:when test="orderqty!=''">
		 		<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="orderqty"/></b></td>
		 	</xsl:when>
		 	<xsl:otherwise>
				...
				<xsl:when test="orderqty!=''">
					<xsl:choose>
	 					<xsl:when test="orderqty = qty">
				 			<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="qty"/></b></td>
				 		</xsl:when>
			 			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="orderlinecost!=''">
				<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="format-number (orderlinecost,'DDD,DDD.00', 'staff')"/>&#160;&#160;</b></td>
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
			</xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="orderlinecost!=''">
				<xsl:choose>
					<xsl:when test="orderlinecost = linecost">
						<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="linecost"/></b></td>
					</xsl:when>
					<xsl:otherwise>
 		...
 		<xsl:choose>
			<xsl:when test="totalorder!=''">
				<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="format-number (totalorder,'DDD,DDD.00', 'staff')"/>&#160;&#160;</b></td>
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
			</xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="totalorder!=''">
				<xsl:choose>
					<xsl:when test="(totalorder=total)">
						<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="format-number (total,'DDD,DDD.00', 'staff')"/>&#160;&#160;</b></td>
					</xsl:when>
					<xsl:when test="(orderqty!=qty)">
						<td class="pcontent" bgcolor="#00d400" align="center"><b><xsl:value-of select="format-number (total,'DDD,DDD.00', 'staff')"/>&#160;&#160;</b></td>
					</xsl:when>
			...
			<xsl:otherwise>
				<td class="pcontent" align="center"><xsl:value-of select="total"/></td>
			</xsl:otherwise>
		</xsl:choose>
		...
		<td class="pcontent" align="center">
			<textarea  name="txtFreeText_{lineid}" id="txtFreeText_{lineid}"  class="tblcontent"><xsl:value-of select="comments"/></textarea>
		</td>
 	</tr>
 </xsl:template>
</xsl:stylesheet>
