...
<%						
										...
										' Order enhancements set download options for all users
										...
										If Request.Form("radAction") <> "" Then
											SQL = "AddToOrdersAuditLog @OrderId=" & OrderId & ",@OrderStatusId=" & Request.Form("radAction")
											'Response.Write SQL
											Dim SqlConnection, rsObj
											Set SqlConnection = Server.CreateObject("ADODB.Connection")
											SqlConnection.Open const_db_ConnectionString
											ExecuteSql SQL, SqlConnection
											SqlConnection.Close
										...
										SQL = "itemOrder @OrderID=" & OrderID & _
											", @IsXML=" & IsXML & _
											", @UserTypeId=1"
