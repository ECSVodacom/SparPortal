...
<xsl:choose>
	...
	<xsl:otherwise>
	<form action='default.asp?item=@@OrdID' method="post" name="updateorder" id="updateorder" onsubmit="return validate(this);">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td class="pcontent" >
					<b>Status:</b> <xsl:value-of select="//rootnode/smmessage/orderstatus"/>
				</td>
			</tr>		
		</table>
		<br/>
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td class="pcontent" align="center">
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/greyoutlistinvoices='0'"> <!--   -->
							<xsl:choose>
								<xsl:when test="//rootnode/smmessage/invoicecount=1">
									<input type="button"  name="btnListInvoices"  id="btnListInvoices" value="List Invoices" onclick="javascript: window.open('@@ApplicationRoot/track/supplier/invoice/default.asp?item={//rootnode/smmessage/invoiceid}','blank');" class="button"/>&#160;
								</xsl:when>
								<xsl:when test="//rootnode/smmessage/invoicecount>1">
									<input type="button"  name="btnListInvoices" id="btnListInvoices" value="List Invoices" onclick="javascript: window.open('@@ApplicationRoot/track/supplier/invoice/list.asp?item=@@OrdID','blank');" class="button"/>&#160;
								</xsl:when>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<input type="button"  name="btnListInvoices" disabled="disabled" id="btnListInvoices" value="List Invoices" class="button" style="background-color: gray;"/>
						</xsl:otherwise>
					</xsl:choose>
					<xsl:choose>
						<xsl:when test="//rootnode/smmessage/isordersavedconfirmation='1'"> 
							<input type="button" name="btnOrderConfirmations" id="btnOrderConfirmations" value="Order Confirmations" onclick="javascript: location.href='@@ApplicationRoot/track/supplier/order/confirmation/new.asp?item=@@OrdID'" class="button"/>&#160;
						</xsl:when>
						<xsl:when test="//rootnode/smmessage/isorderconfirmed='1'"> 
							<input type="button" name="btnOrderConfirmations" id="btnOrderConfirmations" value="Order Confirmations" onclick="javascript: location.href='@@ApplicationRoot/track/supplier/order/confirmation/default.asp?item={//rootnode/smmessage/invoiceid}'" class="button"/>&#160;
						</xsl:when>
						<xsl:when test="//rootnode/smmessage/greyoutorderconfirmation='0'"> 
							<input type="button" name="btnOrderConfirmations" id="btnOrderConfirmations" value="Order Confirmations" onclick="javascript: location.href='@@ApplicationRoot/track/supplier/order/confirmation/new.asp?item=@@OrdID'" class="button"/>&#160;
						</xsl:when>
						<xsl:otherwise>
							<input type="button" name="btnOrderConfirmations" disabled="disabled" id="btnOrderConfirmations" value="Order Confirmations" class="button" style="background-color: gray;"/>
						</xsl:otherwise>
					</xsl:choose>
		...
		<xsl:choose>
			<xsl:when test="//rootnode/smmessage/allowchangeorder='1'"> 
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="pcontent" >
							<input type="radio" name="radAction" id="radAction" value="4" />Extracted by Supplier&#160;&#160;&#160;<input type="submit" name="btnSaveOrder" id="btnSaveOrder" value="Save" class="button"/>&#160; 
						</td>
						<td class="pcontent" >
		...
		<table border="1" cellpadding="0" cellspacing="0" width="100%">
			<tr bgcolor="#4C8ED7">
				...
				<td class="tdcontent" align="center"><b>Deal1 %</b></td>
				<td class="tdcontent" align="center"><b>Deal2 %</b></td>
