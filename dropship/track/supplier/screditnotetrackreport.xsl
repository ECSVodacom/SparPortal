	...
	<xsl:template match="cnote">
		<tr>
			<td class="pcontent" align="center">
				<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/supplier/creditnote/default.asp?item={@id}', 'CreditNoteDetail', 'width=1200,height=800,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
