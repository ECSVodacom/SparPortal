		...
		<td>
			<table border="1" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<xsl:if test="claim/manualnum!=''">
						<th class="pcontent" align="center" bgcolor="#ccccc2">
							<b><i>Manual Claim Number</i></b>
						</th>
						<th class="pcontent" align="center" bgcolor="#ccccc2">
							<b><i>Manual Claim Date</i></b>
						</th>
					</xsl:if>
					<th class="pcontent" align="center" bgcolor="#ccccc2">
...
<xsl:template match="claim">	
	<tr>
		<td class="pcontent" align="center">
			<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/supplier/claim/default.asp?item={@id}', 'ClaimDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
		...
		<xsl:choose>
			<xsl:when test="invid!=''">
				<td class="pcontent" align="center">
					<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/supplier/invoice/default.asp?item={invid}', 'InvoiceDetail', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
					<xsl:value-of select="invnum"/></a>
				</td>				
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
		...
		<xsl:choose>
			<xsl:when test="cncount!='0'">					
				<td class="pcontent" align="center">
					<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/supplier/creditnote/item.asp?item={@id}', 'ListCreditNotes', 'width=800,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
					list</a>
				</td>
			</xsl:when>
			<xsl:otherwise>
