	...
	' Basic Logic Flow:
										...
										if Request.Form("hidAction") = "1" Then
											...
											if ReturnSet("returnvalue") = 0 Then
												...
												'Call SetUserDetails (ReturnSet("UserID"), ReturnSet("UserName"), ReturnSet("FirstName"), ReturnSet("UserType"), ReturnSet("Permission"), ReturnSet("PhysAddress"), ReturnSet("ProcID"), ReturnSet("ProcEAN"), ReturnSet("ProcName"), ReturnSet("IsXML"), 0,0, 0, 0 ,0)
			...
			<td background="<%=const_app_ApplicationRoot%>/layout/images/bg0.gif" height="23">
				<table width="100%" cellspacing="0" cellpadding="0" border="0"> 
					<tr>
						...
						<td><div class="banner"><b>Vodacom Business - SPAR DS Track & Trace // <font color="#FF6F2F" > Production Server</font></b></div></td>
			...
			<td>
				<table class="tablewindow" align="center" cellspacing="0" cellpadding="10" border="0" width="45%">
					...
					<tr>
						<td>
							<br>
								<form method="post" action="default.asp?urlafter=<%=Request.QueryString("urlafter")%>&id=<%=Request.QueryString("id")%>" name="form" onkeypress="getKey()" onsubmit="return validate(this);">
								<center>
...
%>			
									...
									<tr>
										...
										<td class="tdforminput"><input class="text" type="password" name="txtOldPassword" size="25" maxlength="25"></td>
									</tr>
									<tr>
										<td class="tdformhdr">New Password</td>
										<td class="tdforminput"><input class="text" type="password" name="txtNewPassword" size="25" maxlength="25"></td>
									</tr>
									<tr>
										<td class="tdformhdr">Confirm New Password</td>
										<td class="tdforminput">
											<input class="text" type="password" name="txtConfirmNewPassword" size="25" maxlength="25">
