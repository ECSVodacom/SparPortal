...
<%
										SQL = "exec listWebReport_Display @Level = 2, @FromDate = '" & GetFromDate(Request.QueryString("Month"),Request.QueryString("FromMonth"),Request.QueryString("FromDate"),Request.QueryString("Year")) & "', @Todate = '" & MakeToDate(Request.QueryString("Month"),Request.QueryString("Year"),Request.QueryString("ToDate")) & "', @ReportType = '" & Request.QueryString("ReportType") & "', @ReportOn = " & Request.QueryString("ReportOn") & ", @DC = " & Request.QueryString("DC") & ", @Supplier = " & Request.QueryString("Supplier") & ", @Store = " & Request.QueryString("Store")
										'Response.Write(SQL)
										'Response.End 
										XMLString = DoSecondDrillDown(curConnection, SQL, Request.QueryString("Display"))
										...
										DisplaySet = Replace(DisplaySet,"!!","/")
										DisplaySet = Replace(DisplaySet,"@@FirstLocation",const_app_ApplicationRoot & "/Stats/billing/Third.asp?back=yes&dc=")
