...
<!--
	if (<%=Session("IsLoggedIn")%> != 1) {
		...
		top.location.href = "<%=const_app_ApplicationRoot%>/default.asp?urlafter=<%=const_app_ApplicationRoot%>/supplier/item.asp%>";
	};
//-->
</script>					
<%
...
<table border="0" cellpadding="2" cellspacing="2" width="100%">
	<tr>
		<td class="subheader">Add New Supplier</td>
	</tr>
</table>
<%
...
%>
<p class="pcontent">The Supplier <b><%=Request.Form("txtName")%></b> has been added successfully.</p>

<p class="pcontent"><b>Option:</b>
	<ul>
		<li class="pcontent"><a class="stextnav" href="<%=const_app_AdminRoot%>/supplier/item.asp?id=<%=ReturnSet("NewSupplierID")%>">View Supplier detail just added</a></li>
	</ul>
</p>
<%											
										end if
