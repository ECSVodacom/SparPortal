...
<%
										...
										dim FormAction
											...
											DoAdd = False
											FormAction = "doeditsuppliercode.asp"
											...
											if ReturnSet("returnvalue") <> 0 then
												...
												txtIntegrate = ReturnSet("Integrated")
...
<table border="0" cellpadding="2" cellspacing="2" width="100%">
	<tr>
		<td class="bheader">Edit Supplier EAN Numbers</td>
	</tr>
</table>
...
%>
<p class="sheader">Update Existing EAN Numbers</p>
<p class="pcontent">Below is a list of Supplier EAN Numbers <b><%=ReturnSet("SupplierName")%></b>.
	<ul>
		...
		<li class="pcontent">If you wish to edit the EAN Numbers, click inside a text box and change the EAN code and then click on the <b>"Update"</b> button.</li>
		<li class="pcontent">You can also <a class="stextnav" href="#Add">Add</a> a new Supplier EAN Number on this page.</li>
	</ul>
</p>
<form name="EditSupplierCodes" id="EditSupplierCodes" method="post" action="<%=FormAction%>?id=<%=Request.QueryString("id")%>" onsubmit="return validate(this);">
<table border="0" cellpadding="2" cellspacing="2">
	<tr>
		<td class="pcontent"><b>Delete?</b></td>
		<td class="pcontent"><b>Supplier EAN Number</b></td>
		<td class="pcontent"><b>Integrated</b></td>
	</tr>
<%
Counter = 0								
...
%>
	<tr>
		...
		<td><input type="text" name="txtCode<%=Counter%>" id="txtCode<%=Counter%>" value="<%=ReturnSet("SupplierCode")%>" size="20" maxlength="50" class="pcontent">
			<input type="hidden" name="hidSupplierCodeID<%=Counter%>" id="hidSupplierCodeID<%=Counter%>" value="<%=ReturnSet("SupplierCodeID")%>">
		</td>
		<td><input type="checkbox" name="chkIntegrated<%=Counter%>" id="chkIntegrated<%=Counter%>"  <%if ReturnSet("Integrated") = 1 then Response.Write "checked" end if%> class="pcontent"></td>
	</tr>
<%																			
ReturnSet.MoveNext
Wend							
...
%>
	<tr>
		<td colspan="2"><br>
			...
			<input type="hidden" name="chkNGI" id="hiddenNGI" value="<%=Counter%>" >  
...
%>
<p class="sheader">Add a New Supplier EAN Number<a name="Add"></p>
...
<table border="0" cellspacing="2" cellpadding="2">
	<tr>
		<td class="pcontent"><b>EAN Code</b></td>
		<td class="pcontent"><b>Integrated</b></td>
	</tr>
	<tr>
		<td><input type="text" name="txtSupplierCode" id="txtSupplierCode" size="20" maxlength="50" class="pcontent"></td>
		<td><input type="checkbox" name="chkInt" id="chkInt" class="pcontent"></td>
