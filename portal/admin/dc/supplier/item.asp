...
function isChecked() { 
  var checked = document.getElementById("chkIntegrated").checked; 
  if (checked) 
...
%>
	...
	<%if ReadonOnlyPassword = "true" then%>
		<td><input type="text" name="txtPassword" id="txtPassword" value="<%=Password%>" size="20" maxlength="100" readonly class="pcontent" value=""></td>
	<% else %>
		<td><input type="text" name="txtPassword" id="txtPassword" value="<%=Password%>" size="20" maxlength="100"  class="pcontent" value=""></td>
	<%end if%>
	</tr>
	<tr>
		<td class="pcontent"><b>Confirm Password:</b></td>
	<%if ReadonOnlyPassword = "true" then%>
		<td><input type="text" name="txtConfirmPassword" id="txtConfirmPassword" value="<%=Password%>" size="20" maxlength="100"  readonly class="pcontent"></td>
	<% else %>
		<td><input type="text" name="txtConfirmPassword" id="txtConfirmPassword" value="<%=Password%>" size="20" maxlength="100" class="pcontent"></td>
	<%end if%>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="txtMail" id="txtMail" value="<%=txtSupplierMail%>" size="150" maxlength="8000" class="pcontent"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="pcontent"><textarea rows="5" cols="25" id="txtComments" name="txtComments" class="pcontent"><%=txtComments%></textarea></td>
	</tr>
	<tr>
...
%>	
	<tr>
		...
		<td><input type="checkbox" name="chkIntegrated<%=Counter%>" id="chkIntegrated<%=Counter%>" class="pcontent" ></td>
