	...
	' Basic Logic Flow:
										...
										if Request.Form("hidAction") = "1" Then
											...
											if ReturnSet("returnvalue") <> 0 Then
												...
												Call SetUserDetails (ReturnSet("UserID"), Request.Form("txtUserName"), ReturnSet("FirstName"), ReturnSet("Surname"), "", ReturnSet("Permission"), ReturnSet("CompanyID"), ReturnSet("CompanyName"))
...
<p class="pheader">Buyer and Supplier Content Management System</p>
<hr>
