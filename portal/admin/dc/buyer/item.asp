...
%>
		<td class="bheader">Update Buyer Detail</td>
<%
										end if
%>
	</tr>
...
<%
										if DoAdd Then
%>
<p class="pcontent">Complete the form below to add a new buyer</b></p>
<%
										else
%>
...
<table border="0" cellpadding="2" cellspacing="2">
	<tr>
		...
		<td class="pcontent"><input type="text" name="txtUserName" id="txtUserName" value="<%=txtUserName%>" size="20" maxlength="100" class="pcontent"></td>
	</tr>
<%
										if DoAdd = False Then
%>	
...
%>
	...
	<tr>
		...
		<td class="pcontent"><input type="text" name="txtPassword" id="txtPassword" value="<%=GeneratedPassword%>"  readonly="true" size="20" maxlength="100" class="pcontent"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Confirm Password:</b></td>
		<td class="pcontent"><input type="text" name="txtConfirmPassword" id="txtConfirmPassword" value="<%=GeneratedPassword%>"  readonly="true" size="20" maxlength="100" class="pcontent"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>FirstName:</b></td>
		<td class="pcontent"><input type="text" name="txtFirstName" id="txtFirstName" value="<%=txtFirstName%>" size="20" maxlength="100" class="pcontent"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>Surname:</b></td>
		<td class="pcontent"><input type="text" name="txtSurname" id="txtSurname" value="<%=txtSurname%>" size="20" maxlength="100" class="pcontent"></td>
	</tr>
	<tr>
		<td class="pcontent"><b>DC:</b></td>
		<td>
			<select name="lstDC" name="lstDC" class="pcontent">
				<option value="-1">-- Allocate a DC --</option>
<%
										if Session("Permission") = 0 Then
											Select Case CStr(Session("UserID"))
											Case "1"
%>											
...
<%
											Case "7"
%>											
												<option selected value="7">Lowveld</option>
<%
											
											Case "11"
%>											
												<option selected value="7">SSB</option>
<%												
												End Select
										else
%>		
				...
				<option <%if CStr(txtCompanyID) = "7" Then Response.Write "selected" end if%> value="7">Lowveld</option>
				<option <%if CStr(txtCompanyID) = "11" Then Response.Write "selected" end if%> value="11">SSBU</option>
<%
										end if
%>			
			</select>
	...
	<tr>
		...
		<td class="pcontent"><input type="checkbox" name="chkDisable" id="chkDisable" <%if txtDisable = 1 then Response.Write "checked" end if%> class="pcontent"></td>
	</tr>
</table>
<%
...
%>	
	<tr>
		...
		<td class="pcontent"><input type="text" name="txtBuyerCode<%=Counter%>" id="txtBuyerCode<%=Counter%>" size="5" maxlength="10" class="pcontent"></td>
	</tr>
<%
											Next
%>	
...
<br>
<p class="sheader">Buyer E-Mail Addresses</p>
...
%>	
	<tr>
		<td class="pcontent" align="right"><b><%=Counter%>.</b></td>
		<td class="pcontent"><input type="text" name="txtBuyerMail<%=Counter%>" id="txtBuyerMail<%=Counter%>" size="30" maxlength="100" class="pcontent"></td>
	</tr>
<%
											Next
%>	
...
%>
<p class="sheader">Assign Suppliers</p>
...
<table border="0" cellpadding="2" cellspacing="2">
	...
	<tr>
		<td>
			<select multiple size="10" name="lstUnassign" id="lstUnassign" style="width:300" class="pcontent">
<%
...
%>				
		...
		<td>
			<select multiple size="10" name="lstAssign" id="lstAssign" style="width:300" class="pcontent">
<%
										if DoAdd = False Then
											' Call the sp - listUnassignSupplier 
