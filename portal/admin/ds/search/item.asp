...
<%
										...
										if Request.Form("hidAction") = "2" Then
											...
											if strType = 1 then
												' Build the SQL
												SQL = "delOrder @OrderNumber=" & MakeSQLText(Request.Form("hidOrdNum"))
											else
												' Build SQL
												SQL = "delInvoice @InvoiceNumber=" & MakeSQLText(Request.Form("hidInvNum")) & _
...
<%
											...
											Set ReturnSet = ExecuteSql("searchInvoice @StoreID=" & Request.Form("drpStore"), curConnection) 
