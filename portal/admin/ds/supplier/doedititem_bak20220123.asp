...
<%
										...
										SQL = "editSupplier @SupplierID=" & Request.Form("hidSupplierID") & _
...
<%											
											...
											Set ReturnSet = ExecuteSql("delLinkedSuppliers @SupplierID=" & Request.Form("hidSupplierID"), curConnection)   
											' Close the Recordset
											Set ReturnSet = Nothing
												...
												if ReturnSet("returnvalue") <> 0 then
													...
													if DoDelete = 0 then
														...
														For MailCount = 0 to UBound(MailArray)
															...
															SQL = "editVendorMail @VendorID=" & VendorID & _
