				...
				<tr>
					<td>
						<table border="0" cellspacing="2" cellpadding="2" width="100%">
							...
							<tr>
								<td class="pcontent"><b>Turn Store Live</b></td>
								<td><input type="checkbox" name="chkLive" id="chkLive" <%if txtIsLive = 1 then Response.Write "checked" end if%> class="pcontent"></td>
							</tr>
							<tr>
				...
				<tr>
					<td><br>
						...
						<%	
											...
											Set ReturnSet = ExecuteSql("listStoreMail @StoreID=" & txtStoreID, curConnection) 
						...
						%>
							<tr>
								...
								<td class="tbldata"><input type="text" name="txtStoreMail1" id="txtStoreMail1" class="pcontent" size="40" maxlength="100"></td>
							</tr>
						<%	
											else
												Counter = 0
						...
						%>
							<tr>
								...
								<td class="tbldata"><input type="text" name="txtStoreMail<%=Counter%>" id="txtStoreMail<%=Counter%>" value="<%=ReturnSet("StoreMail")%>" class="pcontent" size="40" maxlength="100"></td>
							</tr>
						<%												
													ReturnSet.MoveNext
												Wend
