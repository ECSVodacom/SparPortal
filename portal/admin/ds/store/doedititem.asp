...
<%
										...
										SQL = "exec editStore @StoreID=" & Request.Form("hidStoreID") & _
...
<%
											...
											For Counter = 1 to Request.Form("hidTotalCount")
												...
												SQL = "exec editStoreMail @StoreID=" & Request.Form("hidStoreID") & _
													", @StoreMailID=" & Request.Form("txtMailID" & Counter) & _
											...
											Next
%>
<p class="pcontent">The Detail for Store <b><%=Request.Form("txtName")%></b> has been updated successfully.</p>
<%													
...
<p class="pcontent"><b>NOTE:</b>One of the Email address was not added, deleted or updated successfully.<br><br>
	Please <a class="stextnav" href="<%=const_app_ApplicationRoot%>/store/item.asp?id=<%=Request.Form("hidStoreID")%>"> return to the previous page and try again.</a></p>
<%													
											end if
%>
<p class="pcontent"><b>Option:</b>
	<ul>
		<li class="pcontent"><a class="stextnav" href="<%=const_app_ApplicationRoot%>/store/item.asp?id=<%=Request.Form("hidStoreID")%>">View Changes made</a></li>
	</ul>
</p>
<%											
										end if
