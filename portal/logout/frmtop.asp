	...
	<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" ><a name="top"></a>
						...
						<tr>
							<td bgcolor="#003366" valign="middle" class="topheadnav">
								...
								<table border="0" cellpadding="2" cellspacing="0" width="100%">
									<tr>
										<td class="pheader" align="top">SPAP Portal</td>
									</tr>
								</table>
								<!-- /BREADCRUMB BAR -->
							</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td bgcolor="#ccccc2" class="welcome" width="20%" align="center" valign="middle"><br>Thank You<br> <%=Session("ClientName")%><br><br><br></td>
			</tr>
		</table>
		<!-- /NAVBAR CONTAINER -->														
	</body>
