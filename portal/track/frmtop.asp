...
<html>
						...
						<tr>
							<td align="right" background="<%=const_app_ApplicationRoot%>/layout/images/hdrbg03.gif" height="82">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tbody>
										<tr>
											<td width="80%" align="center"><H1>SPAR REPORTING</H1></td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr>
				<td align="right" background="<%=const_app_ApplicationRoot%>/layout/images/hdrbg04.gif" height="25">&nbsp;&nbsp;<img src="<%=const_app_ApplicationRoot%>/layout/images/bulletcca.gif">&nbsp;<font color="#ffffff">Welcome back&nbsp;</font><font color="#00006A"><b><%=Session("ClientName")%>&nbsp;</b></font></td>
			</tr>
		</tbody>
	</table>	
</html>
