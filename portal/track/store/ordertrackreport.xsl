	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<table border="0" cellpadding="2" cellspacing="2" width="100%">
				...
				<tr>
					<td class="pcontent"><br/>Orders generated per Supplier for <b>@@Date</b>.</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="pcontent">
						<ul>
							...
							<li>Click on the <b>List Invoices</b> link to view the list of Invoices.</li>
						</ul>
					</td>
				</tr>
			</table>
...
<xsl:template match="order">	
	<tr>
		<td class="pcontent">
		<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/order/default.asp?item={@id}', 'OrderDetail', 'width=700,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
		...
		<xsl:choose>
			<xsl:when test="invoicecount='1'">
				<td class="pcontent" align="center">
					<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/store/invoice/list.asp?item={@id}', 'InvoiceDetail', 'width=700,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">list invoices</a>
				</td>
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
