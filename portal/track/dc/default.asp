...
<%
										...
										'StrText = StrText & "tocTab[ir++] = new Array ('0', 'Date Menu', '" & const_app_ApplicationRoot & "/track/frmcontent.asp?id=" & FormatLongDate(Date,false) & "');" & VbCrLf
...
<frameset  rows="105,*" border="0">
	...
	<frameset cols="150,10,*" border="1">
		...
		<frame name="frmcontent" src="frmcontent.asp?id=<%=FormatLongDate(CDate(NewDate),false)%>" scrolling="auto" noresize>
	</frameset>
</frameset>

<!--<frameset  rows="105,*" border="0">
	<frame name="frmTop" src="frmtop.asp" scrolling="no" noresize>
	<frameset cols="150,10,97%" border="1">
		<frameset rows="*,77%,13%" onload="reDisplay('0',true)">
			<frame name="frmtitle" src="frmtitle.asp" scrolling="no" noresize>
			<frame name="toc" src="toc.htm" scrolling="auto" noresize>
			<frame name="frmLogout" src="frmlogout.asp" scrolling="no" noresize>
		 </frameset>
		 <frame name="frmMiddle" src="frmmiddle.asp" scrolling="no" noresize>
		 <frame name="frmcontent" src="frmcontent.asp?id=<%=FormatLongDate(CDate(NewDate),false)%>" scrolling="auto" noresize>
		</frameset>-->
...
<frameset rows="64,*">
  ...
  <frameset cols="150,*">
    <frameset rows="*,77%,13%">
      ...
      <frame name="contents2">
      <frame name="contents1">
    </frameset>
    <frame name="main">
  </frameset>
