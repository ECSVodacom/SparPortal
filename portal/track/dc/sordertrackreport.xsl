...
<xsl:template match="/" xml:space="preserve">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td class="NavLink" bgcolor="#333366" align="center"><a href="@@ApplicationRoot/track/dc/frmcontent.asp?action=2&amp;id=@@Date" class="NavLink" target="frmcontent">Electronic Invoices</a>@@GenInv<!--&#160;/&#160;
