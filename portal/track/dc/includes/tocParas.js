...
var
	...
	normalColor = "#333366",	// text color of the ToC headlines
	lastVisitColor = "#00006A",	// text color of the line last visited
	//currentColor = "#99000",	// text color of the actual line just clicked on
	//currentColor = "#DE0031", // text color of the actual line just clicked on
	...
	textSizes = new Array(1, 0.9, 0.9, 0.7, 0.6),			// font-size factors for: [0] the title "Table of Contents", [1] larger and bold fonts [2] smaller fonts if MS Internet Explorer [3] larger and bold fonts [4] smaller fonts if Netscape Navigator.
