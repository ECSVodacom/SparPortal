...
<%
										...
										XSLDoc.async = false
										'XSLDoc.Load(const_app_ApplicationRoot & "/track/dc/invoice/list.xsl")
										...
										' Calc the Sub Totals
										SubTotExcl = Trim(CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/subtotexcl").text)) - Trade1TotExcl - Trade2TotExcl - AddTotExcl
										SubTotVat =  Trim(CDbl(XMLDoc.selectSingleNode("//rootnode/smmessage/subtotvat").text)) - Trade1TotVat - Trade2TotVat - AddTotVat
										
										'Response.Write SubTotExcl
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="10" topmargin="10" marginwidth="10" marginheight="10" background="<%=const_app_ApplicationRoot%>/layout/images/backgroud.gif" onload="check (<%=Success%>,<%=Session("IsLoggedIn")%>);">
<%
										' Write the XMLString 
