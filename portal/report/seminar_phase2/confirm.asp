...
<%
										...
										Set ReturnSet = ExecuteSql("listConfirmSupplierPhase2 @InviteDate=" & MakeSQLDate(TestDate) & ", @DCID=" & Request.QueryString("dc"), curConnection)   
...
%>
	<tr>
		...
		<td class="tbldata" align="center"><%if ReturnSet("Contract") = 1 then Response.Write "<b>Yes</b>" else Response.Write "<b class='errortext'>No</b>" end if%></td>
		<td class="tbldata" align="center"><%if ReturnSet("DOSigned") = 1 then Response.Write "<b>Yes</b>" else Response.Write "<b class='errortext'>No</b>" end if%></td>
		...
		<td class="tbldata" align="center"><%if ReturnSet("Goldmine") = 1 then Response.Write "<b>Yes</b>" else Response.Write "<b class='errortext'>No</b>" end if%></td>
		...
		<td class="tbldata" align="center"><%if ReturnSet("Implement") = 1 then Response.Write "<b>Yes</b>" else Response.Write "<b class='errortext'>No</b>" end if%></td>
	</tr>
<%												
												ReturnSet.MoveNext
											Wend
