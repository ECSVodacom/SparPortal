<!--
	...
	function calcTotalExcl(id) {
		...
		//document.frmInvoice.elements['txtTotalExcl' + id].disabled = true;
	...
	function calcTransLev (txtObj, rdObj,id) {
		var found_it;
		var Discount;
		var Total1 = document.frmInvoice.txtSubTots1.value;
		var Total2 = document.frmInvoice.txtSubTots2.value;
		var Total3 = document.frmInvoice.txtSubTots3.value;
		...
		if (Math.round(txtObj.value)!=0){
			...
			if (id==2) {
				...
				if (found_it=='1') {
					// Calc the perc val
					Total1 = ((Total1 + parseFloat(document.frmInvoice.elements['txtDBAdjR'+1].value)) * txtObj.value / 100);
					Total2 = ((Total2 + parseFloat(document.frmInvoice.elements['txtDBAdjRVat'+1].value)) * txtObj.value / 100);
					Total3 = ((Total3 + parseFloat(document.frmInvoice.elements['txtDBAdjTotIncl'+1].value)) * txtObj.value / 100);
				} else {
					// Calc the rand val
					Total1 = (txtObj.value);
					Total2 = (txtObj.value);
