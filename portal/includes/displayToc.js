...
// Initializing the ToC window's document and displaying the title on it's top. The ToC is performed by a HTML table:
	...
	//toc.document.write("<A TARGET=\"_top\" HREF=\"/home.asp\"><IMG BORDER=0 ALIGN=center SRC=\"/gifs/selogo.gif\" ALT=\"SiteExperts.com Logo\" WIDTH=170 HEIGHT=104></A>\n<P>");
	toc.document.write("<table border=0 cellspacing=1 cellpadding=0 width=100%>\n<tr>\n<td colspan=" + (nCols+50) + "><a target=\"_top\" href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + tocTab[0][0] + "',0,0)\" style=\"font-family: " + fontTitle + "; font-weight:bold; font-size:" + textSizes[0] + "em; color: " + titleColor + "; text-decoration:none\">" + tocTab[0][1] + "</a></td></tr>\n<tr>");
...
// ...then the hading symbol and the heading text each with a javaScript link caling just this function reDisplay again: 
			//toc.document.writeln("<td valign=top><a target=\"_top\" href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[0] + "," + tocLinks[1] + ",event)\"><img src=\"../layout/images/" + img + ".gif\" width=13 height=12 border=0></a></td> <td colspan=50><a target=\"_top\" href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[1] + "," + tocLinks[1] + ",event)\" style=\"font-family: " + fontLines + ";" + ((thisLevel<=mLevel)?"font-weight:bold":"") +  "; font-size:" + ((thisLevel<=mLevel)?mdi:sml) + "em; color: " + thisTextColor + "; text-decoration:none\">" + ((showNumbers)?(thisNumber+" "):"") + tocTab[i][1] + "</a></td></tr>");
			//toc.document.writeln("<td valign=top><a target=\"_top\" href=\"https://www.spar.co.za\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[0] + "," + tocLinks[1] + ",event)\"><img src=\"../layout/images/" + img + ".gif\" width=13 height=12 border=0></a></td> <td colspan=50><a target=\"_top\" href=\"https://www.spar.co.za\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[1] + "," + tocLinks[1] + ",event)\" style=\"font-family: " + fontLines + ";" + ((thisLevel<=mLevel)?"font-weight:bold":"") +  "; font-size:" + ((thisLevel<=mLevel)?mdi:sml) + "em; color: " + thisTextColor + "; text-decoration:none\">" + ((showNumbers)?(thisNumber+" "):"") + tocTab[i][1] + "</a></td></tr>");
			
			//if (new==true) {
				//toc.document.writeln("<td valign=top><a target=\"_top\" href=\"https://www.spar.co.za\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[0] + "," + tocLinks[1] + ",event)\"><img src=\"../layout/images/" + img + ".gif\" width=13 height=12 border=0></a></td> <td colspan=50><a target=\"_top\" href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[1] + "," + tocLinks[1] + ",event)\" style=\"font-family: " + fontLines + ";" + ((thisLevel<=mLevel)?"font-weight:bold":"") +  "; font-size:" + ((thisLevel<=mLevel)?mdi:sml) + "em; color: " + thisTextColor + "; text-decoration:none\">" + ((showNumbers)?(thisNumber+" "):"") + tocTab[i][1] + "</a></td></tr>");
			//}else{
				toc.document.writeln("<td valign=top><a href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[0] + "," + tocLinks[1] + ",event)\"><img src=\"../layout/images/" + img + ".gif\" width=13 height=12 border=0></a></td> <td colspan=50><a target=\"_top\" href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + thisNumber + "'," + tocBehaviour[1] + "," + tocLinks[1] + ",event)\" style=\"font-family: " + fontLines + ";" + ((thisLevel<=mLevel)?"font-weight:bold":"") +  "; font-size:" + ((thisLevel<=mLevel)?mdi:sml) + "em; color: " + thisTextColor + "; text-decoration:none\">" + ((showNumbers)?(thisNumber+" "):"") + tocTab[i][1] + "</a></td></tr>");
			//};
		}
	} // End of loop over the tocTab
...
// Setting the top or content window's location if required
	if (theHref) 
		...
		else frmcontent.location.href = theHref;
}