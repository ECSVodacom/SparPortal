	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<table border="0" cellpadding="2" cellspacing="2" width="100%">
				...
				<tr>
					<td class="pcontent"><br/>Orders received per Store per Supplier for <b>@@Date</b>.</td>
				</tr>
				<tr>
...
<xsl:template match="store">
	...
	<tr bgcolor="#333366">
		<td class="gheader" colspan="9" width="100%"><xsl:value-of select="name"/></td>
	</tr>
...
<xsl:template match="supplier">
	...
	<tr>
		<td>&#160;</td>
		<td class="nheader" colspan="8" bgcolor="#6699FF"><xsl:value-of select="name"/> (<xsl:value-of select="eannumber"/>)</td>
	</tr>
	<tr>
		<td>&#160;</td>
		<td colspan="7">
...
<xsl:template match="order">	
	<tr>
		<td class="pcontent">
			<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/dc/order/default.asp?item={@id}', 'OrderDetail', 'width=750,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">
		...
		<xsl:choose>
			<xsl:when test="invoicecount='1'">
				<td class="pcontent" align="center">
					<a class="links" href="JavaScript: newWindow = openWin('@@ApplicationRoot/track/dc/invoice/list.asp?item={@id}', 'OrderDetail', 'width=700,height=500,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1');">list invoices</a>
				</td>
			</xsl:when>
			<xsl:otherwise>
				<td class="pcontent" align="center">-</td>
