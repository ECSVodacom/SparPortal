		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<!--<td bgcolor="#ccccc2" class="welcome" width="5%" align="right" valign="middle"><img src="<%=const_app_ApplicationRoot%>/layout/images/logout.gif" border="0">&nbsp;&nbsp;<a class="stextnav" href="javascript:if ( window.confirm('Are you sure you want to log out?')) self.parent.location.href='<%=const_app_ApplicationRoot%>/logout/';">Logout</a><br><br></td>-->
							<td valign="top">
				...
				<td bgcolor="#ccccc2" class="welcome" width="20%" align="center" valign="middle"><br>Welcome<br> <%=Session("ProcName")%><br><br><br></td>
			</tr>
		</table>
		<!-- /NAVBAR CONTAINER -->														
	</body>
