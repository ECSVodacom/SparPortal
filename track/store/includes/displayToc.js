...
// Initializing the ToC window's document and displaying the title on it's top. The ToC is performed by a HTML table:
	...
	toc.document.write("<table border=0 cellspacing=1 cellpadding=0 width=100%>\n<tr>\n<td colspan=" + (nCols+50) + "><a href=\"javaScript:history.go(0)\" onMouseDown=\"parent.reDisplay('" + tocTab[0][0] + "',0,0)\" style=\"font-family: " + fontTitle + "; font-weight:bold; font-size:" + textSizes[0] + "em; color: " + titleColor + "; text-decoration:none\">" + tocTab[0][1] + "</a></td></tr>\n<tr>");
