...
End Function
	...
	const const_app_ApplicationRoot = "http://10.34.49.131/Spar"
	const const_app_Path = "C:\"
	...
	if Files_Collection.Count > 0 Then
		...
		For each File in Files_Collection
			...
			if objXML.LoadXML(Replace(StrText,"&","&amp;")) = False Then
				...
				OrderNumber = objXML.selectSingleNode("//UNH/ODD/ORNO/ORNU").text & GetSuffix(XMLDoc.selectSingleNode("//UNH/CLO/CDPT").text)
				...
				if Not ErrorFlag Then
					...
					' Build the BodyText
					BodyText = "This e-mail contains information on Purchase Orders sent via FirstNet e-commerce." & VbCrLf
					BodyText = BodyText & "Please do not reply to this e-mail." & VbCrLf & VbCrLf
					BodyText = BodyText & "The following Purchase Order Confirmation(s) was/were received:" & VbCrLf & VbCrLf
					BodyText = BodyText & const_app_ApplicationRoot & "/orders/buyer/default.asp?id=" & XMLFolder & "\" & Trim(OrderNumber) & ".xml&type=1" & VbCrLf & VbCrLf  
