...
<%
											...
											' Check if the fiel exist
												if oFile.FileExists (const_app_TabFile & Replace(Request.QueryString("ref"),",","\")) = True Then
											'	Response.Write "Exist"
												...
												objStream.Open
												objStream.LoadFromFile(const_app_TabFile & Replace(Request.QueryString("ref"),",","\"))
												Response.ContentType = "application/xxml"
