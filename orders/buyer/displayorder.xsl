		...
		<table border="0" cellPadding="2" cellSpacing="0" width="100%">
			...
			<tr>
				<td width="33%" VALIGN = "TOP">&#160;</td>
								...
								<td width="33%" VALIGN = "TOP" class="pcontent"><b>Order Type:</b> <xsl:value-of select="DOCUMENT/UNB/UNH/ORD/TRCE/TRCD"/></td>
				<td width="33%" VALIGN = "TOP">&#160;</td>
...
<form name="FormFilter" id="FormFilter" method="post" action="default.asp?id=@@XMLFile&amp;check=0">
	<table border="1" align="center" cellPadding="2" cellSpacing="0" width="100%" bgColor="#ccccc2">
          <tr> 
          	 @@ListBox
	...
	<table  style="font:8pt Arial" border="1" cellPadding="2" cellSpacing="0" width="100%">
		...
		<tr bgColor="#ccccc2">
			...
			<td class="pcontent"><i>Ship<br/>Pack<br/>Order<br/>Qty</i></td>
			...
			<td class="pcontent"><i>UOM<br/></i></td>
		...
		<xsl:for-each select="DOCUMENT/UNB/UNH/OLD">
			<xsl:if test="@status='Confirmed'">
				<tr>
					...
					<td align="right" valign="middle" class="pcontent">
						<xsl:choose>
							<xsl:when test="QNTO/UNOM[. !='']">
								<xsl:value-of select="QNTO/UNOM"/></xsl:when>
							<xsl:otherwise>
								0	
							</xsl:otherwise>
						</xsl:choose>
					...
					<td align="left" valign="top" class="pcontent">
						...
						<xsl:choose>
							<xsl:when test="CRAD/ADJI3[. !='']">
								<xsl:value-of select="CRAD/ADJI3"/>
									<xsl:choose>
										<xsl:when test="CRAD/PERC3[. != '0000000' and . != '000.0000' and .!='' and . != '0.0000' ]">=<xsl:value-of select="CRAD/PERC3"/>% </xsl:when>
						...
						<xsl:choose>
							<xsl:when test="CRAD/ADJI5[. != '']">
								...
								<xsl:choose>
									<xsl:when test="CRAD/PERC5[. != '0000000' and . != '000.0000' and .!='' and . != '0.0000' ]">=<xsl:value-of select="CRAD/PERC5"/>% </xsl:when>
						...
						<xsl:choose>
							<xsl:when test="CRAD/ADJI2[. != ' ']">
								<xsl:value-of select="CRAD/ADJI2"/>
									<xsl:choose>
										<xsl:when test="CRAD/PERC2[. != '0000000' and . != '000.0000' and .!='' and . != '0.0000' ]">=<xsl:value-of select="CRAD/PERC2"/>% </xsl:when>
						...
						<xsl:choose>
							<xsl:when test="CRAD/ADJI4[. != ' ']">
								<xsl:value-of select="CRAD/ADJI4"/>
									<xsl:choose>
										<xsl:when test="CRAD/PERC4[. != '0000000' and . != '000.0000' and .!='' and . != '0.0000' ]">=<xsl:value-of select="CRAD/PERC4"/>% </xsl:when>
						...
						<xsl:choose>
							<xsl:when test="CRAD/ADJI6[. != ' ']">
								<xsl:value-of select="CRAD/ADJI6"/>
									<xsl:choose>
										<xsl:when test="CRAD/PERC6[. != '0000000' and . != '000.0000' and .!='' and . != '0.0000' ]">=<xsl:value-of select="CRAD/PERC6"/>% </xsl:when>
	...
	<table  style="font:8pt Arial" border="1" cellPadding="2" cellSpacing="0" width="100%">
		<tr bgColor="#ccccc2">
			 <td title="Items present in Original Order and not in Confirmation" COLSPAN="15" class="pcontent">&#160;<STRONG>Unconfirmed Items (Present in original order and not in confirmation)</STRONG></td>
		 </tr>
		<tr bgColor="#ccccc2">
			<td class="pcontent"><i>Seq<br/>No</i></td>
			<td class="pcontent"><i>Consumer Barcode<br/>Order Barcode<br/>Supp Prod Code</i></td>
