...
<form name="FormFilter" id="FormFilter" method="post" action="default.asp?id=@@XMLFile">
	...
	<table  style="font:8pt Arial" border="1" cellPadding="2" cellSpacing="0" width="100%">
		<tr bgColor="#ccccc2">
			 <td title="Items present in Original Order and not in Original" COLSPAN="14" class="pcontent">&#160;<STRONG>New Items (Present in Confirmation order and not in Original)</STRONG></td>
		 </tr>
		<tr bgColor="#ccccc2">
